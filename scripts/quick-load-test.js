...
/**
 * CipherPool Quick Load Test Script
 * Simulates 1,000 concurrent users for faster testing
 * 
...
async function runLoadTest() {
  console.log('\n🚀 CipherPool Quick Load Test Started');
  ...
  console.log(`✓ All ${CONFIG.TOTAL_USERS.toLocaleString()} users spawned`);
...
function printResults() {
  ...
  console.log(`   Min: ${metrics.minResponseTime === Infinity ? 'N/A' : metrics.minResponseTime.toFixed(2) + 'ms'}`);
  ...
  console.log(`\n📋 HTTP Status Codes:`);
  Object.entries(metrics.statusCodes).sort().forEach(([code, count]) => {
