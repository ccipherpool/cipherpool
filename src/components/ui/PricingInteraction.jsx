...
export function PricingInteraction({
  ...
  const handleChangePlan = (index) => setActive(index);
      ...
      <div className="w-full relative flex flex-col items-center justify-center gap-3">
        ...
        >
          ...
          <div
            ...
            style={{ borderColor: active === 0 ? "#000" : "#64748b", transition: "border-color 0.3s" }}
          >
            <div
              className="size-3 bg-black rounded-full"
              style={{ opacity: active === 0 ? 1 : 0, transition: "opacity 0.3s" }}
            />
          </div>
        </div>
        ...
        >
          <div className="flex flex-col items-start">
            ...
            <p className="text-slate-500 text-md flex">
              <span className="text-black font-medium flex items-center">
                ${" "}
                <NumberFlow className="text-black font-medium" value={starter} />
              </span>
              /month
            </p>
          </div>
          <div
            className="border-2 border-slate-500 size-6 rounded-full mt-0.5 p-1 flex items-center justify-center"
            style={{ borderColor: active === 1 ? "#000" : "#64748b", transition: "border-color 0.3s" }}
          >
            <div
              className="size-3 bg-black rounded-full"
              style={{ opacity: active === 1 ? 1 : 0, transition: "opacity 0.3s" }}
            />
          </div>
        </div>
        ...
        >
          ...
          <div
            className="border-2 border-slate-500 size-6 rounded-full mt-0.5 p-1 flex items-center justify-center"
            style={{ borderColor: active === 2 ? "#000" : "#64748b", transition: "border-color 0.3s" }}
          >
            <div
              className="size-3 bg-black rounded-full"
              style={{ opacity: active === 2 ? 1 : 0, transition: "opacity 0.3s" }}
            />
          </div>
        </div>
