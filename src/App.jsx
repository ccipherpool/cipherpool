        ...
        <Route path="*" element={
          <div style={{ minHeight:"100vh", background:"#050508", display:"flex", alignItems:"center", justifyContent:"center" }}>
            <div style={{ textAlign:"center" }}>
              <h1 style={{ fontSize:80, fontFamily:"monospace", color:"#dc2626", margin:0 }}>404</h1>
              <p style={{ color:"rgba(255,255,255,.3)", fontFamily:"monospace", letterSpacing:4, fontSize:12, marginBottom:32 }}>PAGE NON TROUVÉE</p>
              <a href="/" style={{ padding:"13px 32px", background:"#dc2626", color:"#fff", fontFamily:"monospace", fontSize:11, letterSpacing:2, textDecoration:"none" }}>← ACCUEIL</a>
            </div>
          </div>
        } />
